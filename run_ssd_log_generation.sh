...
#SBATCH --cpus-per-task=60                 # XX CPU threads for that process
...
python simulate.py --log_path raw_data/experiment_1_settings/original_model/experiment_1_bimp_log.csv --case_id case_id --activity_name activity --resource_name resource --end_timestamp end_time --start_timestamp start_time --num_simulations 30 --central_orchestration --num_cores=${SLURM_CPUS_PER_TASK}